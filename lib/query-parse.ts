...
const CATEGORY_ALIASES: { id: CategoryId; words: string[] }[] = [
  ...
  { id: "grocery", words: ["بقالة", "زيت", "ارز", "أرز", "سكر", "مكرونة", "grocery"] },
  { id: "sports", words: ["رياضة", "جيم", "جري", "دمبل", "sports"] },
  { id: "auto", words: ["عربيه", "عربية", "سيارة", "كاوتش", "زيت موتور"] },
  { id: "tools", words: ["شنيور", "عدة", "مفك", "عدد"] },
  { id: "pets", words: ["قطط", "كلاب", "حيوانات", "رمل قطط"] },
  { id: "office", words: ["مكتبية", "ورق a4", "حبر", "طابعة"] },
  { id: "garden", words: ["حديقة", "بلكونة", "زرع", "اصيص"] },
