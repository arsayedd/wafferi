  ...
  return (
    <article className="mx-auto max-w-3xl space-y-6 px-4 py-10 leading-relaxed">
      ...
      <section className="space-y-2 text-sm text-muted-foreground">
        ...
        <h2 className="text-lg font-medium text-foreground">حدود المحرك</h2>
        <p>
          أفكار الجدولة والتنبيه من أدوات مفتوحة (ChangeDetection، مسار Apify التجاري) من غير تثبيت
          Crawlee أو Playwright ومن غير تجاوز حماية المواقع. بنقرأ JSON-LD/فيد مصرّح، مش بنزحف كتالوج مصر.
        </p>
        <p>
