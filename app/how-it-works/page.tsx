    ...
    <article className="mx-auto max-w-3xl space-y-8 px-4 py-10 leading-relaxed">
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          حتى لو السكرابينج مش جريمة واضحة في القانون المصري، شروط الاستخدام عند جوميا
          ونون ومعظم المتاجر بتمنعه صراحة، وقانون مكافحة جرائم تقنية المعلومات ممكن
          يتقرأ على الوصول غير المصرّح لأنظمة المواقع. كمان التقنيًا: حظر IP، كابتشا،
          وتغيير HTML. عشان كده عمود البيانات عندنا فيد أفلييت/رسمي أو ملف يستورده التاجر،
          مش زاحف على كل الدومينات.
        </p>
      </section>
      <section className="space-y-2">
