...
export default function StoresPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10">
      <h1 className="font-heading text-3xl font-semibold">شبكة مصادر شراء العروسة في مصر</h1>
      <p className="mt-2 max-w-3xl text-muted-foreground">
        ماركتبليس، هايبر، ديبارتمنت، سلاسل أجهزة، بوتيكات فساتين، صاغة، صيدليات، وأحياء
        الجملة زي حمام التلات وعبدالعزيز. الربط يتم بأفلييت أو فيد أو شراكة. الأحياء
        الفيزيائية في حالة تواصل: بنعرّف المصدر من غير ما نلفّق أسعار سكرابينج.
      </p>
