  ...
  return (
    <aside className="rounded-xl bg-muted/50 p-4 text-sm leading-relaxed text-muted-foreground">
      ...
      <p className="mt-1">
        ...
        أصحابها. وفّري مش مالكة للكتالوج ولا للأسعار اللحظية. كل منتج متربط بعرض مصدر:
        الاسم ظاهر، والضغط بيفتح موقعهم. الصور هنا توضيحية (من ضمنها Unsplash) وليست
        بالضرورة صورة المنتج الرسمية عند التاجر.
      </p>
    </aside>
  );
}
