...
const modules = [
  ...
  },
  {
    ...
    icon: Scale,
    title: "المقارنة",
    text: "نفس المنتج من أكتر من مصدر. الشراء عندهم، وفّري مش البائع.",
  },
  {
    href: "/places",
    icon: MapPinned,
  ...
  },
  {
    ...
    icon: Store,
    title: "المصادر",
    text: "الأسماء حقوق أصحابها. المنتج يتربط بمتجره، من غير مخزون حي عندنا.",
  },
];
          ...
          <Reveal>
            ...
            <ul className="mt-6 space-y-3 text-muted-foreground">
              {[
                ...
                "تقارن عروض مرجعية لنفس المنتج — من غير ما تبيع.",
              ].map((t) => (
          ...
          <Reveal delay={120}>
            ...
            <ul className="mt-6 space-y-3 text-muted-foreground">
              {[
                ...
                "مش مخزون حي بيتحدّث كل ثانية — الداتا دي مش عندنا.",
